...
namespace Legal.Forms.GraphicsInspector
{
    public partial class FormGraphicsView : FormLbr.FormBase
    {
        ...
        private void GraphView()
        {
            switch (cmbView.SelectedIndex)
            {
                ...
                case 1: GraphicDGVEF.Visible = true;
                    ...
                    string select = "select * from vG_GraphicPointView order by CodeAbonent ";
                ...
                try
                {
                    ...
                    dsAbn.Tables["vG_GraphicPointView"].Clear();
                    ...
                    dAdapt.Fill(dsAbn, "vG_GraphicPointView");
        ...
        private void tsbOrderAll_Click(object sender, EventArgs e)
        {
            FormGraphicPointOrder f = new FormGraphicPointOrder();
            f.MdiParent = this.MdiParent;
            f.SqlSettings = new DataSql.SQLSettings(this.SqlSettings);
            f.Show();
        }

        private void tsbOrderAll_Plomb_Schm_Click(object sender, EventArgs e)
        {
            FormGraphicPointOrder_Plomb_Schm f = new FormGraphicPointOrder_Plomb_Schm();
            f.MdiParent = this.MdiParent;
            f.SqlSettings = new DataSql.SQLSettings(this.SqlSettings);
            f.Show();
        }

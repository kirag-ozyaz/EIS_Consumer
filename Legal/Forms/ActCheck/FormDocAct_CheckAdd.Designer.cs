namespace Legal.Forms.ActCheck
{
    partial class FormDocAct_CheckAdd
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.nudCos.Maximum = new decimal(new int[] {
            1000,
            0,
            0,
            0});
            ...
            this.nudFc.Maximum = new decimal(new int[] {
            1000,
            0,
            0,
            0});
            ...
            this.nudFb.Maximum = new decimal(new int[] {
            1000,
            0,
            0,
            0});
            ...
            this.nudFa.Maximum = new decimal(new int[] {
            1000,
            0,
            0,
            0});
            ...
            this.Load += new System.EventHandler(this.FormDocAct_CheckAdd_Load);

...
namespace Legal.Forms
{
    public partial class FormAbnDoc_Dogovor : FormLbr.FormBase
    {
        ...
        private void btnOK_Click(object sender, EventArgs e)
        {
            ...
            dsAbnDocum1.tAbnDoc_Dogovor.Rows[0]["SourceContract"] = rtbSourceContract.Text;
            dsAbnDocum1.tAbnDoc_Dogovor.Rows[0]["SumContract"] = txtSumContract.Value;
            dsAbnDocum1.tAbnDoc_Dogovor.Rows[0]["VolumeContract"] = txtVolumeContract.Value;
        ...
        private void btnViewTemplate_Click(object sender, EventArgs e)
        {
            switch (Convert.ToInt32(lbListTemplate.SelectedValue))
            {
                ...
                case Constants.Constants.TemplDopSogl4:
                    ...
                    break;
                case 2469:
                    TemplVolumBudget(dataGridView1);
                    break;
        ...
        private void DogovorPer(int par)
        {
            ...
            this.SelectSqlData(dsAbnDocum1, dsAbnDocum1.tAbnContact, true, " where idAbn = " + IDABN.ToString() + " order by DateChange desc");
            ...
            int Summa = 0;
            if (par == 2)
                this.SelectSqlData(dsAbnDocum1, dsAbnDocum1.vG_Budget, true, " where idAbn = " + IDABN.ToString());
            ...
            if (dsAbnDocum1.tG_AbnInfo.Count > 0)
            {
                ...
                if (dsAbnDocum1.tG_AbnInfo.Rows[0]["OKVED"] != System.DBNull.Value)
                    SearchAndReplace("[Абонент_ОКВЭД]", dsAbnDocum1.tG_AbnInfo.Rows[0]["OKVED"].ToString());
                else
                    SearchAndReplace("[Абонент_ОКВЭД]", "");

                if (dsAbnDocum1.tG_AbnInfo.Rows[0]["OKPO"] != System.DBNull.Value)
                    SearchAndReplace("[Абонент_ОКПО]", dsAbnDocum1.tG_AbnInfo.Rows[0]["OKPO"].ToString());
                else
                    SearchAndReplace("[Абонент_ОКПО]", "");

                if (dsAbnDocum1.tG_AbnInfo.Rows[0]["OGRN"] != System.DBNull.Value)
                    SearchAndReplace("[Абонент_ОГРН]", dsAbnDocum1.tG_AbnInfo.Rows[0]["OGRN"].ToString());
                else
                    SearchAndReplace("[Абонент_ОГРН]", "");

                if (dsAbnDocum1.tG_AbnInfo.Rows[0]["Email"] != System.DBNull.Value)
                    SearchAndReplace("[Абонент_Email]", dsAbnDocum1.tG_AbnInfo.Rows[0]["Email"].ToString());
                else
                    SearchAndReplace("[Абонент_Email]", "");

                // новые реквизиты для контрактов

                if (dsAbnDocum1.tG_AbnInfo.Rows[0]["OKTMO"] != System.DBNull.Value)
                    SearchAndReplace("[Абонент_ОКТМО]", dsAbnDocum1.tG_AbnInfo.Rows[0]["OKTMO"].ToString());
                else
                    SearchAndReplace("[Абонент_ОКТМО]", "");

                if (dsAbnDocum1.tG_AbnInfo.Rows[0]["OKOGU"] != System.DBNull.Value)
                    SearchAndReplace("[Абонент_ОКОГУ]", dsAbnDocum1.tG_AbnInfo.Rows[0]["OKOGU"].ToString());
                else
                    SearchAndReplace("[Абонент_ОКОГУ]", "");

                if (dsAbnDocum1.tG_AbnInfo.Rows[0]["OKFS"] != System.DBNull.Value)
                    SearchAndReplace("[Абонент_ОКФС]", dsAbnDocum1.tG_AbnInfo.Rows[0]["OKFS"].ToString());
                else
                    SearchAndReplace("[Абонент_ОКФС]", "");

                if (dsAbnDocum1.tG_AbnInfo.Rows[0]["OKOPF"] != System.DBNull.Value)
                    SearchAndReplace("[Абонент_ОКОПФ]", dsAbnDocum1.tG_AbnInfo.Rows[0]["OKOPF"].ToString());
                else
                    SearchAndReplace("[Абонент_ОКОПФ]", "");

                if (dsAbnDocum1.tG_AbnInfo.Rows[0]["KBK"] != System.DBNull.Value)
                    SearchAndReplace("[Абонент_КВК]", dsAbnDocum1.tG_AbnInfo.Rows[0]["KBK"].ToString());
                else
                    SearchAndReplace("[Абонент_КВК]", "");

                if (dsAbnDocum1.tG_AbnInfo.Rows[0]["PersonalAccount_1"] != System.DBNull.Value)
                    SearchAndReplace("[Абонент_Счет1]", dsAbnDocum1.tG_AbnInfo.Rows[0]["PersonalAccount_1"].ToString());
                else
                    SearchAndReplace("[Абонент_Счет1]", "");

                if (dsAbnDocum1.tG_AbnInfo.Rows[0]["PersonalAccount_2"] != System.DBNull.Value)
                    SearchAndReplace("[Абонент_Счет2]", dsAbnDocum1.tG_AbnInfo.Rows[0]["PersonalAccount_2"].ToString());
                else
                    SearchAndReplace("[Абонент_Счет2]", "");

                if (dsAbnDocum1.tG_AbnInfo.Rows[0]["Phone"] != System.DBNull.Value)
                    SearchAndReplace("[Абонент_Телефоны]", dsAbnDocum1.tG_AbnInfo.Rows[0]["Phone"].ToString());
                else
                    SearchAndReplace("[Абонент_Телефоны]", "");
            ...
            else
            {
                if (dsAbnDocum1.tG_AbnAddress1.Count > 0)
                    SearchAndReplace("[Абонент_ПочтовыйАдрес]", dsAbnDocum1.tG_AbnAddress1.Rows[0]["Representation"].ToString());
            }
            ...
            if (dsAbnDocum1.tAbnContact.Count > 0)
                SearchAndReplace("[Абонент_Телефоны]", dsAbnDocum1.tAbnContact.Rows[0]["Phone"].ToString());

            if (par == 2)
            {
                int vol = 0;
                decimal sm = 0;
                if (dsAbnDocum1.vG_Budget.Count > 0)
                {
                    vol = (int)dsAbnDocum1.vG_Budget.Rows[0]["Volume"];
                    sm = (int)dsAbnDocum1.vG_Budget.Rows[0]["Summa"];
                }

                if (rtbSourceContract.Text != "")
                    SearchAndReplace("[Источник_Контракт]", rtbSourceContract.Text);
                else
                    SearchAndReplace("[Источник_Контракт]", "___________");

                int rub = 0;
                int kop = 0;
                if (txtSumContract.Value > 0)
                {
                    rub = Convert.ToInt32(Math.Truncate(txtSumContract.Value));
                    kop = (int)Math.Round((txtSumContract.Value - rub) * 100);
                    SearchAndReplace("[Сумма_Контракт]", rub.ToString());
                    SearchAndReplace("[Копейки_Контракт]", kop.ToString("D2"));
                }
                else
                {
                    if (sm > 0)
                    {
                        rub = Convert.ToInt32(Math.Truncate(sm));
                        kop = (int)Math.Round((sm - rub) * 100);
                        SearchAndReplace("[Сумма_Контракт]", rub.ToString());
                        SearchAndReplace("[Копейки_Контракт]", kop.ToString("D2"));
                    }
                    else
                    {
                        SearchAndReplace("[Сумма_Контракт]", "___________");
                        SearchAndReplace("[Копейки_Контракт]", "___________");
                    }
                }

                if (txtVolumeContract.Value > 0)
                    SearchAndReplace("[Volume]", txtVolumeContract.Value.ToString());
                else
                {
                    if (vol > 0)
                        SearchAndReplace("[Volume]", vol.ToString());
                    else
                        SearchAndReplace("[Volume]", "___________");
                }
            }
        }
...
//                SearchAndReplace("[Абонент_ФамилияИмяОтчество_1]", dsAbnDocum1.tG_AbnChief.Rows[0]["I_I"].ToString().Substring(1, 1) + "." + dsAbnDocum1.tG_AbnChief.Rows[0]["I_O"].ToString().Substring(1, 1) + "." + dsAbnDocum1.tG_AbnChief.Rows[0]["I_F"].ToString());
            ...
            {
                SearchAndReplace("[Исполнитель]", "И.И.Перятинец");
                SearchAndReplace("[Телефон]", "274898");
            }
        }
            ...
            try
            {
                ...
                if (dgvData.SelectedRows.Count > 0)
                {
                    ...
                    if (printState)
                    {
                        ...
                        //SelectSqlData(dsAbnDocum1, dsAbnDocum1.vG_BudgetMonth, true, " where idAbn = " + IDABN.ToString());
        ...
        private void TemplVolumBudget(DataGridView dgvData)
        {
            try
            {
                OfficeLB.Word.Application word;
               ...
               // if (dgvData.SelectedRows.Count > 0)
                //{
                    ...
                    if (printState)
                    {
                        ...
                        if (dsAbnDocum1.vG_BudgetMonth.Rows.Count > 0)
                        {
                            try
                            {
                                word = new OfficeLB.Word.Application();    // Запускаем Word
                            ...
                            for (int i = 0; i < dsAbnDocum1.vG_BudgetMonth.Rows.Count; i++)
                            {
                                newrow1 = rows.Add();
                                newrow1.Height = 10.0;                                     // Устанавливаем высоту строки
                                newrow1.Range.Orientation = OfficeLB.Word.WdTextOrientation.wdTextOrientationHorizontal;     // Устанавливаем ориентацию страницы альбомной
                                newrow1.Range.Cells[1].Range.Text = dsAbnDocum1.vG_BudgetMonth.Rows[i]["Name"].ToString();     // Заполняем новую строку данными
                                ...
                                if (txtVolumeContract.Value > 0)
                                {
                                    ...
                                    for (int j = 1; j < dsAbnDocum1.vG_BudgetMonth.Columns.Count - 2; j++)
                                    {
                                        newrow.Range.Cells[j].Range.Text = dsAbnDocum1.vG_BudgetMonth.Rows[i][j + 2].ToString();     // Заполняем новую строку данными
                                        Volum = Volum + Convert.ToInt32(dsAbnDocum1.vG_BudgetMonth.Rows[i][j + 2]);
                                    }
